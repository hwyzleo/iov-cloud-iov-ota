CREATE TABLE IF NOT EXISTS `tb_software_package`
(
...
CREATE TABLE IF NOT EXISTS `tb_software_build_version`
(
    `id`                   BIGINT       NOT NULL AUTO_INCREMENT COMMENT '主键',
    `device_code`          VARCHAR(20)  NOT NULL COMMENT '设备编码',
    `software_pn`          VARCHAR(50)  NOT NULL COMMENT '软件零件号',
...
CREATE TABLE IF NOT EXISTS `tb_software_build_version_package`
(
    `id`                        BIGINT    NOT NULL AUTO_INCREMENT COMMENT '主键',
...
CREATE TABLE IF NOT EXISTS `tb_software_build_version_dependency`
(
    `id`                                   BIGINT    NOT NULL AUTO_INCREMENT COMMENT '主键',
...
CREATE TABLE IF NOT EXISTS `tb_compatible_pn`
(
    `id`            BIGINT       NOT NULL AUTO_INCREMENT COMMENT '主键',
...
CREATE TABLE IF NOT EXISTS `tb_data_sync_record`
(
    `id`          BIGINT    NOT NULL AUTO_INCREMENT COMMENT '主键',
