...
import net.hwyz.iov.cloud.ota.pota.service.infrastructure.repository.dao.CompatiblePnDao;
...
public class CompatiblePnAppService {
    ...
    private final CompatiblePnDao compatiblePnDao;
    ...
    public List<CompatiblePnPo> search(String deviceCode, Integer type, Date beginTime, Date endTime) {
        ...
        return compatiblePnDao.selectPoByMap(map);
    }
    ...
    public CompatiblePnPo getCompatiblePnById(Long id) {
        return compatiblePnDao.selectPoById(id);
    }
    ...
    public int createCompatiblePn(CompatiblePnPo compatiblePn) {
        return compatiblePnDao.insertPo(compatiblePn);
    }
    ...
    public int modifyCompatiblePn(CompatiblePnPo compatiblePn) {
        return compatiblePnDao.updatePo(compatiblePn);
    }
    ...
    public int deleteCompatiblePnByIds(Long[] ids) {
        return compatiblePnDao.batchPhysicalDeletePo(ids);
    }
